...
<body class="font-sans">
    ...
    <header class="bg-orange-500 text-white py-4">
        <div class="container mx-auto flex justify-between items-center">
            <h1 class="text-2xl font-bold">GotJung HOTEL</h1>
            <div class="flex items-center space-x-4">
                <nav class="flex space-x-4 font-bold">
                    <a href="#" class="hover:text-gray-200">Home</a>
                    <a href="#rooms" class="hover:text-gray-200">Room</a>
                    <a href="#contact" class="hover:text-gray-200">Contact</a>
                </nav>
                <div class="flex items-center space-x-4">
                    <span class="border-l border-white h-6"></span>
                    <?php if (isset($_SESSION['user_name'])): ?>
                        <!-- แสดงชื่อผู้ใช้และไอคอน -->
                        <div class="flex items-center space-x-2">
                            <i class="fas fa-user"></i>
                            <span class="font-bold"><?= htmlspecialchars($_SESSION['user_name']); ?></span>
                            <a href="logout.php" class="bg-orange-700 px-4 py-2 rounded hover:bg-orange-600">Logout</a>
                        </div>
                    <?php else: ?>
                        <!-- แสดงปุ่มเข้าสู่ระบบ -->
                        <a href="../User/User_Login.php" class="bg-orange-700 px-4 py-2 rounded hover:bg-orange-600">เข้าสู่ระบบ</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <!-- Hero Section -->
    <section class="relative bg-cover bg-center h-screen" style="background-image: url('../assets/images/259ff3b1-f7c8-47d2-9abf-4e7957760d8d.jpg');">
        <div class="absolute inset-0 flex flex-col items-center justify-center text-white">
            <div class="bg-black bg-opacity-70 p-12 rounded-lg text-center">
                ...
                <div class="mt-10">
                    <a href="#rooms" class="bg-orange-500 px-10 py-3 font-bold rounded hover:bg-orange-600">Book now</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<div class="mt-4">';
                            echo '<a href="booking.php?room_id=' . $row['id_rooms'] . '" class="bg-orange-500 text-white font-bold w-full block text-center py-2 rounded hover:bg-orange-600">Book now</a>';
                            echo '</div>';
                            echo '</div>';
                        }
                    } else {
                        // แสดงข้อความเมื่อไม่มีข้อมูลในตาราง
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden flex w-4/5 max-w-5xl">
                ...
                <div div class="w-1/2 p-10">
                    <form action="#" method="POST">
                        ...
                        <div class="mt-6">
                            <button type="submit" class="bg-orange-500 text-white px-4 py-2 rounded hover:bg-blue-700">Send message</button>
                        </div>
                    </form>
                </div>
            </div>
